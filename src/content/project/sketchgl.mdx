...
import img_WaveParticle from "../../assets/projects/sketchgl/wave-particle.png"

たとえば、[WebGL Practice Ground](/projects/webgl-practice-ground)で公開している波状パーティクルのデモは、SketchGLを使うと次のように書けます。

<DemoLinkWithResult
  url="https://tetracalibers.github.io/webgl-practice-ground/particle-wave-texture/"
  result={img_WaveParticle}
  title="WebGL2による波状パーティクル"
/>
