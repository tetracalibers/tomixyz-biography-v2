...
<div
  class="demo"
  style="margin-block: 25px; width:200px; height:200px; background-color: #D2E0FB; box-shadow: inset 4px 6px 8px rgba(142, 172, 205, 0.7);"
></div>
...
![](../../assets/tech/svg-inset-shadow/blur.svg)
...
![](../../assets/tech/svg-inset-shadow/blur-in-alpha-1.svg)
...
![](../../assets/tech/svg-inset-shadow/blur-in-alpha-2.svg)
...
<div
  class="demo"
  style="margin-block: 25px; width:200px; height:200px; background-color: #D2E0FB; box-shadow: 0 0 8px black;"
></div>
...
![](../../assets/tech/svg-inset-shadow/box-shadow-behind.svg)
...
![](../../assets/tech/svg-inset-shadow/box-shadow.svg)
...
<div
  class="demo"
  style="margin-block: 25px; width:200px; height:200px; background-color: #D2E0FB; box-shadow: 4px 6px 8px black;"
></div>
...
![](../../assets/tech/svg-inset-shadow/offset-shadow.svg)
...
<div
  class="demo"
  style="margin-block: 25px; width:200px; height:200px; background-color: #D2E0FB; box-shadow: 4px 6px 8px rgba(142, 172, 205, 0.7);"
></div>
...
![](../../assets/tech/svg-inset-shadow/use-flood.svg)
...
![](../../assets/tech/svg-inset-shadow/color-shadow.svg)
...
以下の図では、グレーに塗られている部分が影となる四角形、赤い枠線内が元の`<rect />`部分（`SourceAlpha`の領域）![](../../assets/tech/svg-inset-shadow/diff.svg)

`<feComposite />`の`in`属性を影の四角形、`in2`属性を`SourceAlpha`としよう。

このとき、`operator="xor"`と指定すると、`in`画像と`in2`画像の**重ならない**部分のみが残る。

![](../../assets/tech/svg-inset-shadow/xor.svg)
...
![](../../assets/tech/svg-inset-shadow/xor-and-in.svg)
...
![](../../assets/tech/svg-inset-shadow/inset-shadow-1.svg)
...
![](../../assets/tech/svg-inset-shadow/inset-shadow-2.svg)
...
![](../../assets/tech/svg-inset-shadow/half-opacity.svg)
...
![](../../assets/tech/svg-inset-shadow/outside.svg)
...
![](../../assets/tech/svg-inset-shadow/blur-outside.svg)
...
![](../../assets/tech/svg-inset-shadow/inset-shadow-only.svg)
...
![](../../assets/tech/svg-inset-shadow/inset-shadow-3.svg)
