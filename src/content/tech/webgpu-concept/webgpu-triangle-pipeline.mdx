...
import img_WebGpuTriangleNoBuffer from "../../../assets/tech/webgpu-concept/webgpu-triangle.png"
...
> [!tip]
> 前回解説した、[何番目のテクスチャに出力するのか](/tech/webgpu-concept/webgpu-triangle-shader#何番目のテクスチャに出力するのか)というセクションを復習してみましょう。
